...
where dbid in (db_id('CallGate'),db_id('AnyTradeDB'),db_id('BestTradeDB'),db_id('GoTradeDB'),db_id('RepCallGate'),db_id('RepAnyTradeDB'),db_id('RepBestTradeDB'),db_id('RepGoTradeDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
