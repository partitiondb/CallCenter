...
where dbid in (db_id('CallGate'),db_id('AnyTradeDB'),db_id('BestTradeDB'),db_id('GoTradeDB'),db_id('CallGlobalDB'),db_id('RepCallGate'),db_id('RepAnyTradeDB'),db_id('RepBestTradeDB'),db_id('RepGoTradeDB'),db_id('RepCallGlobalDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
...
create table CallCenters
	(	CallCenterId		PartitionDBType			not null primary key
...
create table Topics
	(	CallCenterId		PartitionDBType			not null references CallCenters (CallCenterId)
...
insert into PdbCallCenters (CallCenterId,CallCenterNumber,Name,URL,Company) values (1,'001','Any Trade','http://www.partitiondb.com/anytrade/','Any Trade Ltd');
insert into PdbCallCenters (CallCenterId,CallCenterNumber,Name,URL,Company) values (2,'002','Best Trade','http://www.partitiondb.com/besttrade/','Best Trade Ltd');
insert into PdbCallCenters (CallCenterId,CallCenterNumber,Name,URL,Company) values (3,'003','Go Trade','http://www.partitiondb.com/gotrade/','Go Trade Ltd');
insert into PdbCallCenters (CallCenterId,CallCenterNumber,Name,URL,Company) values (4,'004','High Trade','http://www.partitiondb.com/hightrade/','High Trade Ltd');
insert into PdbCallCenters (CallCenterId,CallCenterNumber,Name,URL,Company) values (5,'005','One Trade','http://www.partitiondb.com/onetrade/','One Trade Ltd');
insert into PdbCallCenters (CallCenterId,CallCenterNumber,Name,URL,Company) values (6,'006','Top Trade','http://www.partitiondb.com/toptrade/','Top Trade Ltd');
...
insert into PdbTopics (CallCenterId,Subject) values (4,'General');
insert into PdbTopics (CallCenterId,Subject) values (4,'Problem');
insert into PdbTopics (CallCenterId,Subject) values (4,'Strategy');
insert into PdbTopics (CallCenterId,Subject) values (4,'Trading');
insert into PdbTopics (CallCenterId,Subject) values (4,'Tips & Tricks');
...
insert into PdbDepartments (CallCenterId,Id,Name) values (4,1,'Sales');
insert into PdbDepartments (CallCenterId,Id,Name) values (4,2,'Enginneering');
...
begin
	...
	join PdbCallCenters CallCenters on Employees.CallCenterId = CallCenters.CallCenterId
